...
# Add paths
ASRNN_DIR = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, ASRNN_DIR)
sys.path.insert(0, os.path.join(ASRNN_DIR, "model_wrapper"))
...
def main():
    ...
    parser.add_argument('--data-root', type=str, default='data/SpeechCommands',
    ...
    if not os.path.exists(train_data_root):
        ...
        print("  python ../../Task_GSC/download_GSC.py")
        return
    ...
    train_dataset = SpeechCommandsDataset(
        train_data_root, label_dct, transform=transform, mode="train"
    )
