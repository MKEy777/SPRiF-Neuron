...
def main():
    ...
    p.add_argument("--config", default="config/default_matched.yaml")
    p.add_argument("--checkpoint", required=True, help="<model>/seed_x/checkpoint.pt")
    p.add_argument("--output", default="results_matched/figures/raster.png")
    ...
    # label which channels are cue1 vs cue2
