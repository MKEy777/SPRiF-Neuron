...
from model_ablation_b import PermutedMNIST, SPRiFpSMNISTNetAblationB

def get_args():
    parser = argparse.ArgumentParser(description="SPRiF Ablation B: PS-MNIST merged slow/fast")
    ...
    parser.add_argument("--tbptt-len", type=int, default=262, help="TBPTT chunk (0=full BPTT)")
...
def main():
    ...
    model = SPRiFpSMNISTNetAblationB(input_size=1, hidden_sizes=list(args.hidden_sizes),
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(f"Epoch {epoch:03d} | Train Loss: {train_loss/max(train_total,1):.4f} | "
              f"Train Acc: {train_acc:.2f}% | Test Loss: {test_loss/max(test_total,1):.4f} | "
