"""
SPRiF Ablation A — ECG (QTDB) training with ω=0 (no rotation coupling).

Usage:
    python train_ablation_a.py --train-mat ./data/QTDB_train.mat --test-mat ./data/QTDB_test.mat
...
from model_ablation_a import SPRiFECGModelAblationA


def get_args():
    parser = argparse.ArgumentParser(description="SPRiF Ablation A: ECG ω=0")
    # Training
