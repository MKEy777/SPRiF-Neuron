"""
LIF-GSC: Google Speech Commands training with LIF neuron networks.

Usage:
    python train_lif.py --data-root /path/to/speech_commands_v0.02
"""
...
def get_args():
    parser = argparse.ArgumentParser(description="LIF-GSC: Google Speech Commands")
    # Training
