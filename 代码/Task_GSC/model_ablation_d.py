"""SPRiF Ablation D model wrapper for GSC (free 3x3 A matrix, unconstrained recurrence)."""
import torch
import torch.nn as nn
from core_algorithm.sprif_layer_ablation_d import SPRiFNeuronLayerAblationD


class SPRiFGSCNetAblationD(nn.Module):
    def __init__(
        self,
        input_size: int,
        hidden_sizes,
