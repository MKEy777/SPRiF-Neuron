...
class TaskConfig:
    ...
    train_intervention_fraction: float = 0.15
    ...
    train_intervention_counts: list[int] = field(default_factory=lambda: [0, 1, 2, 4, 8])
    eval_intervention_counts: list[int] = field(default_factory=lambda: [0, 1, 2, 4, 8, 16, 32, 40])
